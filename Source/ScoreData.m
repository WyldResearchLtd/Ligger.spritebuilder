...
{
    if (_scoreLevel==nil)
        _scoreLevel=[NSNumber numberWithInt:0];
    
    NSArray* objects = [NSArray arrayWithObjects: _scoreValue, _timeRemaining,_scoreLevel, _scoreName, _scoreDate,_UserGUID, _DeviceGUID, nil];
    
    NSArray* keys = [NSArray arrayWithObjects: @"scoreValue", @"timeRemaining", @"scoreLevel", @"scoreName", @"scoreDate",@"UserGUID", @"DeviceGUID", nil];
